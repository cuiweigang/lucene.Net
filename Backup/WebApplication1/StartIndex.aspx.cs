...
{
    public partial class StartIndex : System.Web.UI.Page
    {
        private static ILog log = LogManager.GetLogger(typeof(StartIndex));
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //for (int i = 1; i <= GetMaxThreadId(); i++)
            {
                ...
                try
                {
                    ...
                    string url = siteURL+"showtopic-" + i + ".aspx";
            ...
            ClientScript.RegisterStartupScript(GetType(),"alert","alert('索引成功！')",true);
        }
